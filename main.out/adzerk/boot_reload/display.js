...
return (function (p__7953){
var vec__7954 = p__7953;
var attr = cljs.core.nth.call(null,vec__7954,(0),null);
var v = cljs.core.nth.call(null,vec__7954,(1),null);
...
var args7957 = [];
var len__7652__auto___7960 = arguments.length;
var i__7653__auto___7961 = (0);
while(true){
if((i__7653__auto___7961 < len__7652__auto___7960)){
args7957.push((arguments[i__7653__auto___7961]));

var G__7962 = (i__7653__auto___7961 + (1));
i__7653__auto___7961 = G__7962;
continue;
} else {
}
break;
...
var len__7652__auto___7965 = arguments.length;
var i__7653__auto___7966 = (0);
while(true){
if((i__7653__auto___7966 < len__7652__auto___7965)){
args__7659__auto__.push((arguments[i__7653__auto___7966]));

var G__7967 = (i__7653__auto___7966 + (1));
i__7653__auto___7966 = G__7967;
continue;
} else {
}
break;
...
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__7660__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq7964){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq7964));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__7968){
var map__7972 = p__7968;
...
var data = map__7972__$1;
var message = cljs.core.get.call(null,map__7972__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__7972__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__7972__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__7974 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__7974,goog.events.EventType.CLICK,((function (G__7974,map__7972,map__7972__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__7974,map__7972,map__7972__$1,data,message,line,file))
);

return G__7974;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__7975){
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__7982){
...
var messages = map__7986__$1;
var warnings = cljs.core.get.call(null,map__7986__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__7986__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__7988 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__7988,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__7988,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__7989){
var map__7992 = p__7989;
...
var messages = map__7992__$1;
var warnings = cljs.core.get.call(null,map__7992__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__7992__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__7992,map__7992__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__7992,map__7992__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__7992,map__7992__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__7992,map__7992__$1,messages,warnings,exception))
;
